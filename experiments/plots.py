...
plt.axhline(y=min(ai), color=color3, linestyle='--', label=f'Min Artificial = {min(ai)}m')
...
# plt.show()
plt.savefig("error_per_point_datasize_wo_discretization.eps", bbox_inches='tight', format="eps")
